package org.ivandgetic.raypick;

import org.ivandgetic.AppConfig;
import org.ivandgetic.ogles.lib.Projector;
...
public class PickFactory {
	...
	public static void update(float screenX, float screenY) {
		...
		// z = 0 , 得到P0
		gProjector.gluUnProject(screenX, openglY, 0.0f,AppConfig.gpMatrixViewArray, 0, AppConfig.gpMatrixProjectArray,0, AppConfig.gpViewport, 0, gpObjPosArray, 0);
		// 填充射线原点P0
		gPickRay.mvOrigin.set(gpObjPosArray[0], gpObjPosArray[1],gpObjPosArray[2]);
		// z = 1 ，得到P1
		gProjector.gluUnProject(screenX, openglY, 1.0f,AppConfig.gpMatrixViewArray, 0, AppConfig.gpMatrixProjectArray,0, AppConfig.gpViewport, 0, gpObjPosArray, 0);
		// 计算射线的方向，P1 - P0
